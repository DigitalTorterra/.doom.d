...
- [ ] Configure Vim support
  - [ ] ~C-a~, ~C-x~ to increment/decrement numbers
  - [ ] ~C-k~ to insert digraph numbers
  - [ ] ~g j~ and ~g k~ to move wrapped lines
  - [ ] Add ~evil-surround~ bindings
...
(after! org
  (setq org-capture-templates
        (append org-capture-templates
                ...
                ("ds" "Spanish" entry
                    (file+headline "~/org/flashcards/spanish.org" "Definitions")
                    (file "~/org/templates/tpl-vocab.txt"))))))
#+end_src
